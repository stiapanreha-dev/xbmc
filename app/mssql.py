...
class MSSQLConnection:
    def __init__(self):
        ...
        # Пустой charset по умолчанию - pymssql автоматически определит кодировку
        # для каждого типа поля (nvarchar=UTF-16, varchar=cp1251 по collation)
        self.charset = os.getenv('MSSQL_CHARSET', '')
